...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mirai.conf'
CONFIGFOLDER='/root/.mirai'
COIN_DAEMON='miraid'
COIN_CLI='mirai-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Mirainodes/Mirainodes/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
