...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/miraid.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/mirai-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/mirai-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/mirai.ico %{buildroot}%{_datadir}/pixmaps/mirai.ico
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/mirai16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/mirai32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/mirai64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/mirai128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/mirai256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/mirai256.png %{buildroot}%{_datadir}/pixmaps/mirai16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/mirai256.png %{buildroot}%{_datadir}/pixmaps/mirai32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/mirai256.png %{buildroot}%{_datadir}/pixmaps/mirai64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/mirai256.png %{buildroot}%{_datadir}/pixmaps/mirai128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/mirai256.png %{buildroot}%{_datadir}/pixmaps/mirai256.xpm
