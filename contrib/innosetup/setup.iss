...
#define MyAppName "Mirainodes"
#define MyAppPublisher "2022 Mirainodes developers"
#define MyAppURL "https://mirainodes.com/"
#define MyAppExeName "mirai-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/MIRAI/bootstrap.zip"
...
DefaultDirName={autopf}\Mirainodes
...
OutputDir=.\output
OutputBaseFilename=MirainodesSetup
...
DefaultGroupName=Mirainodes Core
...
[Files]
Source: ".\package\mirai-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Mirainodes\Mirainodes-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Mirainodes\Mirainodes-Qt,strDataDir|{userappdata}\Mirainodes\}');
  Result := True;
end;
