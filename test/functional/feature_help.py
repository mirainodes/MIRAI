...
"""Verify that starting mirai with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mirai with -? for help text")
        ...
        self.log.info("Start mirai with -version for version information")
