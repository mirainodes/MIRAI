Contributing to Mirainodes Core
============================

The Mirainodes Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mirainodes/mirai/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Mirainodes Core project, and is not to be
confused with overall Mirainodes Network Protocol consensus changes.

Whether a pull request is merged into Mirainodes Core rests with the project merge
...
Patches that change Mirainodes consensus rules are considerably more involved than
...
Where a patchset proposes to change the Mirainodes consensus, it must have been
...
The project leader is the release manager for each Mirainodes Core release.
