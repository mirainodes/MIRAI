...
* Update manpages, see [gen-manpages.sh](https://github.com/mirainodes/MIRAI/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/mirainodes/mirainodes-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/mirainodes/mirainodes.git
