...
{
    const char* pszTimestamp = "FOR EVERY SAINT THERE IS A PAST AND FOR EVERY SINNER THERE IS A FUTURE";
    const CScript genesisOutputScript = CScript() << ParseHex("0434b6e078c28fd368e0e6346817ae3273cf8aacae5ebf9b60087871abf93981e42d33502e87bb471cae102b23043754b5dc3064e9a7dedb018188b8fee4f83635") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1724918944, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        //  uint32_t nGenesisTime = 1724918944;
        //  arith_uint256 test;
        //  bool fNegative;
        //  bool fOverflow;
        ...
        genesis = CreateGenesisBlock(1724918944, 129987, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000e8b6b98386b543b8dfd47af9a04b79d3e320ca4613e3aa6279c01a8e11f"));
        assert(genesis.hashMerkleRoot == uint256S("0xd24464bc880925dc50fccfceb1b82142f348c5e43d2ced1c432d0ed33dc0735d"));
        ...
        consensus.nMaxMoneyOut = 22073017 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "041129d0aa603d79403abab4020f7d47010c6fa8538176ca64a5daa5ef14de87aebfb33991f38c34d0483c8257200fc0c04a98e9bc01724390d5dd474526834099";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;

        // dev address
        consensus.devAddress = "iRufMnNjxyC1tNu2DFwiarCC4MYFLJGidj";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.mirainodes.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.mirainodes.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.mirainodes.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.mirainodes.com"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.mirainodes.com"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.mirainodes.com"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.mirainodes.com"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.mirainodes.com"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x33)(0xe2)(0xbe)(0x0d).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x33)(0xe2)(0x8c)(0x82).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0xdf)(0xb8).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // mirai starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet mirai addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet mirai script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet mirai BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mirai BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet mirai BIP44 coin type is '1' (All coin's testnet default)
