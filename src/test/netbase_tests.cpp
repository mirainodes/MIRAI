...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:30075", "127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:30075", "127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:30075", "::ffff:127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[::]:30075", "::", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("::30075", "::30075", -1));
    BOOST_CHECK(TestSplitHost(":30075", "", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[]:30075", "", __PORT_MAINNET__));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:30075", "127.0.0.1:30075"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:30075", "[::]:30075"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
