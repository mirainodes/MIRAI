...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MIRAI features */
        {"mirai", "listmasternodes", &listmasternodes, true },
        {"mirai", "getmasternodecount", &getmasternodecount, true },
        {"mirai", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"mirai", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"mirai", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"mirai", "masternodecurrent", &masternodecurrent, true },
        {"mirai", "startmasternode", &startmasternode, true },
        {"mirai", "createmasternodekey", &createmasternodekey, true },
        {"mirai", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"mirai", "listmasternodeconf", &listmasternodeconf, true },
        {"mirai", "getmasternodestatus", &getmasternodestatus, true },
        {"mirai", "getmasternodewinners", &getmasternodewinners, true },
        {"mirai", "getmasternodescores", &getmasternodescores, true },
        {"mirai", "preparebudget", &preparebudget, true },
        {"mirai", "submitbudget", &submitbudget, true },
        {"mirai", "mnbudgetvote", &mnbudgetvote, true },
        {"mirai", "getbudgetvotes", &getbudgetvotes, true },
        {"mirai", "getnextsuperblock", &getnextsuperblock, true },
        {"mirai", "getbudgetprojection", &getbudgetprojection, true },
        {"mirai", "getbudgetinfo", &getbudgetinfo, true },
        {"mirai", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"mirai", "mnfinalbudget", &mnfinalbudget, true },
        {"mirai", "checkbudgets", &checkbudgets, true },
        {"mirai", "mnsync", &mnsync, true },
        {"mirai", "spork", &spork, true },
        {"mirai", "getcollateral", &getcollateral, true},
...
{
    return "> mirai-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30076/\n";
}
