...
/** Utility functions used by the Mirainodes Qt UI.
 */
namespace GUIUtil
{
...
// Render MIRAI addresses in monospace font
...
// Parse "mirai:" URI into recipient object, return true on successful parsing
