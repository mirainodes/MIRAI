...
/* Mirainodes GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Mirainodes"
#define QAPP_ORG_DOMAIN "mirainodes.com"
#define QAPP_APP_NAME_DEFAULT "Mirainodes-Qt"
#define QAPP_APP_NAME_TESTNET "Mirainodes-Qt-testnet"
